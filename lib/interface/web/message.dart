...
class WebMessage extends BaseMessage {
  ...
  Message createFaceMessage(
      {int index = 0, required String data, String? operationID}) {
  ...
  Message createFileMessageByURL(
      {required FileElem fileElem, String? operationID}) {
  ...
  Message createImageMessageFromFullPath(
      {required String imagePath, String? operationID}) {
  ...
  Message createQuoteMessage(
      {required String text, required Message quoteMsg, String? operationID}) {
  ...
  Message createSoundMessageByURL(
      {required SoundElem soundElem, String? operationID}) {
  ...
  Message createVideoMessageByURL(
      {required VideoElem videoElem, String? operationID}) {
  ...
  @override
  Future deleteAllMsgFromLocal({String? operationID}) {
    // TODO: implement deleteAllMsgFromLocal
    throw UnimplementedError();
  }

  @override
  Future deleteAllMsgFromLocalAndSvr({String? operationID}) {
    // TODO: implement deleteAllMsgFromLocalAndSvr
    throw UnimplementedError();
  }

  @override
  Future deleteMessageFromLocalAndSvr(
  ...
  Future<SearchResult> findMessageList(
      {required List<SearchParams> searchParams, String? operationID}) {
